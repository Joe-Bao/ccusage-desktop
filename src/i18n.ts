...
const zh = {
  ...
  "update.description": "当前版本 {current}，可前往 GitHub Releases 下载并覆盖安装。",
  "update.view": "查看更新",
  "update.dismiss": "暂时关闭更新提示",
  ...
  "settings.privacy.title": "Usage 数据留在本机",
  "settings.privacy.description": "内置 ccusage 离线读取数据；启动时仅向 GitHub 查询最新版本，不会上传会话或费用信息。",
...
const en: Record<MessageKey, string> = {
  ...
  "update.description": "You are using {current}. Download the installer from GitHub Releases.",
  ...
  "settings.privacy.title": "Usage data stays local",
  "settings.privacy.description": "The bundled ccusage reads data offline. Startup only checks GitHub for a version tag; no session or cost data is uploaded.",
